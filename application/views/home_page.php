  ...
  <div id="rev_slider" class="rev_slider"  data-version="5.0">
    ...
    <!-- SLIDE  -->
      <li data-transition="fade">
        <!-- MAIN IMAGE -->
        <img src="<?php echo base_url(); ?>assets/images/main_image/school_full_image_banner.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg">							
        <!-- LAYER NR. 1 -->
        ...
        data-start="1500"><p style="color:#ff6600;">
...
.client_pic {
    width: 120px;   /* change size as you want */
    height: 120px;  /* keeps it uniform */
    object-fit: cover;
