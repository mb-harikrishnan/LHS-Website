...
<div class="card">
    ...
    <div class="employee-form-card">
        ...
        <form id="newsform"
              method="post"
              action="<?php echo base_url('update_employee'); ?>">

            <!-- Employee ID -->
            <input type="hidden"
                   id="employee_id"
                   name="employee_id"
                   value="<?php echo $employee->emId; ?>">
            ...
            <div class="form-grid">
                ...
                <div class="news-form-group">
                    ...
                    <input type="text"
                           ...
                           value="<?php echo htmlspecialchars($employee->emName); ?>">
                ...
                <div class="news-form-group">
                    ...
                    <input type="password"
                           ...
                           value="<?php echo htmlspecialchars($employee->emPassword); ?>">
                ...
                <div class="news-form-group">
                    ...
                    <input type="text"
                           ...
                           value="<?php echo htmlspecialchars($employee->emPhoneNo); ?>">
                ...
                <div class="news-form-group">
                    ...
                    <input type="text"
                           ...
                           value="<?php echo htmlspecialchars($employee->emDesigId); ?>">
                ...
                <div class="news-form-group">
                    ...
                    <select id="class_id"
                        ...
                        <?php
                        $class_master = $this->db
                            ->query("SELECT * FROM class_master")
                            ->result();
                        ...
                        ?>
                            ...
                            <option value="<?php echo $class->cmId; ?>"
                                <?php echo ($employee->emClass == $class->cmId) ? 'selected' : ''; ?>>
                ...
                <div class="news-form-group">
                    ...
                    <select id="division_id"
                        ...
                        <?php
                        $division_master = $this->db
                            ->query("SELECT * FROM division_master")
                            ->result();
                        ...
                        ?>
                            ...
                            <option value="<?php echo $division->dmId; ?>"
                                <?php echo ($employee->emDiv == $division->dmId) ? 'selected' : ''; ?>>
                ...
                <div class="news-form-group">
                    ...
                    <select id="role_id"
                        ...
                        <?php
                        $user_roles = $this->db
                            ->query("SELECT * FROM user_roles WHERE status = 1")
                            ->result();
                        ...
                        ?>
                            ...
                            <option value="<?php echo $role->role_id; ?>"
                                <?php echo ($employee->user_id == $role->role_id) ? 'selected' : ''; ?>>
