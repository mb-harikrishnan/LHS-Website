...
<div class="card">
    ...
    <div class="card-head">
        <div class="card-title">
            ...
            Co Curricular All Images
        </div>

        <button class="card-action"
                onclick="window.location.href='<?php echo base_url('activities_add'); ?>'">
            <i class="fa fa-upload"></i> Add Image
        </button>
    </div>

    <!-- FILTER -->
    <form method="post" action="<?php echo base_url('activities_list'); ?>">
    ...
    .then((result) => {
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('delete_activities_image'); ?>",
                type: "POST",
                data: {id:id},
