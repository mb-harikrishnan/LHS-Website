...
<div class="card">
    <div class="card-head">
        ...
        <button class="card-action"
                onclick="window.location.href='<?php echo base_url('add_term'); ?>'">
            <i class="fa fa-upload"></i> Add Term
        </button>
    </div>
        ...
        <table class="report-table display nowrap" id="reportsDataTable" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row->tmCode; ?></td>
                 
                    <td>
                        <button class="deleteBtn" data-id="<?php echo $row->tmId; ?>">
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('delete_term'); ?>",
                type: "POST",
                data: { id: id },
